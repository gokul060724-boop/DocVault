...
// ==========================================
// ROOT-LEVEL HTML ROUTES
// ==========================================
// The HTML files are stored in the repository root.
// Keep these routes AFTER `app` is initialized.
app.get("/", (req, res) => {
...
app.get("/create-pin.html", (req, res) => {
    res.sendFile(path.join(__dirname, "create-pin.html"));
});

app.get("/create-password.html", (req, res) => {
    res.sendFile(path.join(__dirname, "create-password.html"));
});

app.get("/viewer-login.html", (req, res) => {
